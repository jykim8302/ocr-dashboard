...
이 저장소에는 Claude 기반의 **완전 커스터마이즈 AI 비서**가 함께 들어 있습니다.

- **Windows**: `AI실행.bat` 더블클릭
- **Mac**: `AI실행.command` 더블클릭

필요한 프로그램을 알아서 설치하고 브라우저가 열립니다. 화면 왼쪽에서 AI의 이름, 성격,
말투, 존댓말/반말, 유머 정도, 창의성, 모델, 생각 깊이, 인터넷 검색 등 40여 가지 설정을
바로 바꿀 수 있고, 캐릭터를 프리셋으로 저장해 두고 골라 쓸 수 있습니다.

자세한 설명은 [`my_ai/README.md`](my_ai/README.md) 를 참고하세요.
